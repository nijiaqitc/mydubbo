 ...
 */
package com.njq.mydubbo.common.threadpool.support;
...
import com.njq.mydubbo.common.utils.JVMUtil;
...
public class AbortPolicyWithReport extends ThreadPoolExecutor.AbortPolicy {
    ...
    private void dumpJStack() {
        ...
        pool.execute(() -> {
            String dumpPath = url.getParameter(CommonConstants.DUMP_DIRECTORY, System.getProperty("user.home"));
