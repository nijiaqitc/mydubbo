...
import com.njq.mydubbo.config.api.ArgumentConfig;
import com.njq.mydubbo.config.api.ConsumerConfig;
import com.njq.mydubbo.config.api.MethodConfig;
...
import com.njq.mydubbo.config.spring.ReferenceBean;
                        ...
                        if (value.length() > 0) {
                            if ("registry".equals(property) && RegistryConfig.NO_AVAILABLE.equalsIgnoreCase(value)) {
                                ...
                                if (isPrimitive(type)) {
                                    ...
                                    /**
                                     * 此处是实例化一个新的运行时类，用于记录暴露服务关联的类，并不是立即装载进服务类中，这是因为加载此服务类时，它关联的类可能还未初始化
                                     */
