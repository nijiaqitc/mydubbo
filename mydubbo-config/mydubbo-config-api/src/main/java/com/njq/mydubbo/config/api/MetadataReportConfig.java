...
public class MetadataReportConfig extends AbstractConfig {
    ...
    private static final String PREFIX_TAG = StringUtils.camelToSplitName(
            MetadataReportConfig.class.getSimpleName().substring(0, MetadataReportConfig.class.getSimpleName().length() - 6), CommonConstants.PROPERTIES_CHAR_SEPERATOR);
    ...
    public String getPrefix() {
        return StringUtils.isNotEmpty(prefix) ? prefix : (CommonConstants.DUBBO + "." + PREFIX_TAG);
    }
