...
import com.njq.mydubbo.registry.api.retry.FailedNotifiedTask;
import com.njq.mydubbo.registry.api.retry.FailedRegisteredTask;
import com.njq.mydubbo.registry.api.retry.FailedSubscribedTask;
import com.njq.mydubbo.registry.api.retry.FailedUnregisteredTask;
import com.njq.mydubbo.registry.api.retry.FailedUnsubscribedTask;
...
import static com.njq.mydubbo.registry.api.Constants.DEFAULT_REGISTRY_RETRY_PERIOD;
import static com.njq.mydubbo.registry.api.Constants.REGISTRY_RETRY_PERIOD_KEY;
    ...
    public void subscribe(URL url, NotifyListener listener) {
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(urls)) {
                ...
                logger.error("Failed to subscribe " + url + ", Using cached list: " + urls + " from cache file: " + getUrl().getParameter(CommonConstants.FILE_KEY, System.getProperty("user.home") + "/dubbo-registry-" + url.getHost() + ".cache") + ", cause: " + t.getMessage(), t);
            } else {
                // If the startup detection is opened, the Exception is thrown directly.
                boolean check = getUrl().getParameter(Constants.CHECK_KEY, true)
                        && url.getParameter(Constants.CHECK_KEY, true);
